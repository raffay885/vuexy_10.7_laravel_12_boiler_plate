                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="app-brand justify-content-center mb-6">
                                    ...
                                    <span class="app-brand-text demo text-heading fw-bold">eSyncro</span>
                                    </a>
                                </div>
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-6 form-password-toggle form-control-validation position-relative">
